...
або «його результат»
  * чий результат - для людини - adj
  * результат чого - для процесу - noun
але «їхній потенціал (людей/лісів):
це характеристика неживого предмета, а характеристики здебільшого трактуються (метафорично) як щось, властиве, належне об'єкту. 
Скажімо, краса лісів - їхня краса (ліси - об'єкт, що має характеристику "краса"). 
Але от кількість лісів - їх кількість, бо кількість чого? лісів - тут інша конструкція, де головне слово кількість. (Не запитаєш же чия кількість?) 
Так само тривалість дня - його тривалість - тут його є формою від "він", бо тривалість чого? дня. (а не чия тривалість?)
...
Загалом: в більшості випадків, фактично де немає потім р.в. мн. ставимо adv (зокрема якщо можна поміняти «багато» на «більше»): багато часу, багато хто/що, багато чого...
Коли "багато" (як і "мало") не відмінюються (й не можуть відмінюватися у певній позиції), то треба adv.
